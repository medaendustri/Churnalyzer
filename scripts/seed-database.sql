...
-- Create sample posts
INSERT INTO Post (slug, title, excerpt, content, imageUrl, categoryId, interactiveData) VALUES 
(
  'the-rise-and-fall-of-nokia',
  'The Rise and Fall of Nokia: From Paper Mill to Mobile Giant',
...
Today, Nokia continues as a network infrastructure company, having sold its mobile division to Microsoft in 2014.',
  '/images/nokia-headquarters.jpg',
  1,
  '{"type": "timeline", "events": [{"year": 1865, "title": "Founded as paper mill", "description": "Fredrik Idestam establishes Nokia as a paper mill in Finland"}, {"year": 1967, "title": "Electronics division", "description": "Nokia enters electronics market"}, {"year": 1987, "title": "First mobile phone", "description": "Nokia launches Mobira Cityman"}, {"year": 1998, "title": "Market leader", "description": "Becomes world''s largest mobile phone manufacturer"}, {"year": 2007, "title": "iPhone launches", "description": "Apple disrupts the mobile industry"}, {"year": 2014, "title": "Microsoft acquisition", "description": "Nokia sells mobile division to Microsoft"}]}'
),
(
  'blockbuster-streaming-wars-netflix',
...
The Blockbuster vs Netflix saga continues to serve as a cautionary tale for established companies and an inspiration for disruptors across all industries.',
  '/images/blockbuster-netflix.jpg',
  1,
  '{"type": "comparison", "title": "Blockbuster vs Netflix Timeline", "data": [{"year": 1997, "blockbuster": "9,000 stores worldwide", "netflix": "Founded, DVD-by-mail service"}, {"year": 2000, "blockbuster": "Declined to buy Netflix for $50M", "netflix": "Offered to sell to Blockbuster"}, {"year": 2007, "blockbuster": "Launched Blockbuster Online", "netflix": "Introduced streaming service"}, {"year": 2010, "blockbuster": "Filed for bankruptcy", "netflix": "Expanded internationally"}, {"year": 2013, "blockbuster": "Closed remaining stores", "netflix": "Launched original content"}]}'
),
(
...
The Theranos story serves as a powerful reminder that innovation without integrity is not just worthless—it''s dangerous. In healthcare, where lives are at stake, the consequences of deception can be fatal.',
  '/images/theranos-building.jpg',
  2,
  '{"type": "autopsy", "causeOfDeath": "Systematic fraud and deception", "symptoms": ["Fake technology claims", "Inaccurate test results", "Investor deception", "Regulatory violations"], "lessonsLearned": ["Verify extraordinary claims", "Demand transparency", "Protect whistleblowers", "Prioritize patient safety"], "timeline": [{"date": "2003", "event": "Theranos founded"}, {"date": "2013", "event": "Peak valuation $9B"}, {"date": "2015", "event": "WSJ exposé published"}, {"date": "2018", "event": "Criminal charges filed"}, {"date": "2022", "event": "Holmes convicted"}]}'
);
