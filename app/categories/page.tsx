...
export const metadata = {
  ...
  description: "Browse business failure case studies by category - tech companies, startups, products, and platforms.",
}
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center mb-16">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">Browse by Category</h1>
        <p className="mt-6 text-lg leading-8 text-slate-600">
          Explore business failures organized by industry and company type to find the most relevant lessons for your
          situation.
        </p>
      </div>
        ...
        {categories.map((category) => (
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-sm text-slate-600">{getCategoryDescription(category.slug)}</p>
      ...
      {/* Featured Categories */}
      <div className="mt-24">
        <h2 className="text-2xl font-bold text-slate-900 mb-8">Most Popular Categories</h2>
          ...
          {categories
            ...
            .map((category) => (
              ...
              >
                ...
                <div className="relative">
                  <div className="mb-4 text-4xl">{getCategoryIcon(category.slug)}</div>
                  <h3 className="text-2xl font-bold mb-2">{category.name}</h3>
                  <p className="text-slate-300 mb-4">{getCategoryDescription(category.slug)}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-400">{category._count?.posts || 0} case studies</span>
                    <Link
                      href={`/categories/${category.slug}`}
