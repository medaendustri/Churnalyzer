    ...
    const mockPosts = [
      {
        id: "1",
        title:
          "The Rise and Fall of Nokia: From Paper Mill to Mobile Giant to Decline",
        ...
        category: {
          ...
          slug: "tech-companies",
          description:
            "Technology companies that failed to adapt to market changes",
        },
      },
      {
        id: "2",
        title:
          "Blockbuster vs Netflix: The Streaming Revolution That Changed Everything",
        ...
        category: {
          ...
          slug: "platforms",
          description:
            "Platform businesses that failed to evolve with technology",
        },
      },
      {
        id: "3",
        ...
        category: {
          ...
          slug: "startups",
          description:
            "Startup companies that failed due to fraud or mismanagement",
        },
      },
    ];
